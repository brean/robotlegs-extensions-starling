...
package robotlegs.bender.extensions.modularity.impl
{
	 ...
	 * @private
	 */
	public class StarlingContextViewBasedExistenceWatcher
	{
		 ...
		 * @private
		 */
		public function StarlingContextViewBasedExistenceWatcher(context:IContext, contextView:DisplayObjectContainer)
		{
