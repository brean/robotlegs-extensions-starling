...
package robotlegs.bender.extensions.mediatorMap.impl
{
	...
	[Event(name="mediatorCreate", type="robotlegs.bender.extensions.mediatorMap.api.StarlingMediatorFactoryEvent")]
	[Event(name="mediatorRemove", type="robotlegs.bender.extensions.mediatorMap.api.StarlingMediatorFactoryEvent")]
	/**
	 * @private
	 */
	public class StarlingMediatorFactory extends EventDispatcher implements IStarlingMediatorFactory
	{
		 ...
		 * @private
		 */
		public function StarlingMediatorFactory(injector:Injector)
		{
			_injector = injector;
		}
		 ...
		 * @inheritDoc
		 */
		public function getMediator(item:Object, mapping:IStarlingMediatorMapping):Object
		{
		...
		public function createMediators(item:Object, type:Class, mappings:Array):Array
		{
			...
			var mediator:Object;
			for each (var mapping:IStarlingMediatorMapping in mappings)
			{
		...
		public function removeMediators(item:Object):void
		{
			...
			if (hasEventListener(StarlingMediatorFactoryEvent.MEDIATOR_REMOVE))
			{
				for (var mapping:Object in mediators)
				{
					dispatchEvent(new StarlingMediatorFactoryEvent(
						StarlingMediatorFactoryEvent.MEDIATOR_REMOVE,
		...
		private function createMediator(item:Object, mapping:IStarlingMediatorMapping):Object
		{
		...
		private function addMediator(mediator:Object, item:Object, mapping:IStarlingMediatorMapping):void
		{
			_mediators[item] ||= new Dictionary();
			_mediators[item][mapping] = mediator;
			if (hasEventListener(StarlingMediatorFactoryEvent.MEDIATOR_CREATE))
				dispatchEvent(new StarlingMediatorFactoryEvent(
					StarlingMediatorFactoryEvent.MEDIATOR_CREATE,
